...
import { addOrder, getAllOrdersWithEachProducts, getOrder, getOrdersWithSingleProducts } from '../controllers/orderController.js';
...
router
  ...
  .get(protect("user"), getAllOrdersWithEachProducts);
